...
import com.automic.packages.feature.cipher.Password;
import com.automic.packages.feature.globalcodes.ErrorCodes;
import com.automic.packages.feature.utils.CommandLineWrapper;
import com.automic.packages.feature.utils.Maxim;
import com.automic.packages.util.Logger;
...
public class AraFileCmd {
	...
	public static void main(String[] args) {
		FeatureUtil.logMsg("ldap-tool", MsgTypes.GENERAL);
		FeatureUtil.logMsg("(c) Automic Software GmbH", MsgTypes.GENERAL);
		try {			
			FeatureUtil.logMsg("Version: "
					+ FeatureUtil.getCompiledVersion("ldap-tool"), MsgTypes.GENERAL);
			
			FeatureUtil.logMsg("Date: "
					+ FeatureUtil
					.getCompiledDate("ldap-tool"), MsgTypes.GENERAL);
			FeatureUtil.logMsg("");
